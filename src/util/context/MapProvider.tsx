...
export default function MapProvider({ children }: Props) {
  ...
  const [viewable, setViewable] = useState<{ [K in (typeof mapElements)[number]]: boolean }>({ "markers": true, "geofence": true, "loiter radius": true, "accept radius": false, "terrain": false })
