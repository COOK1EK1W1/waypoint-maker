...
export default function Terms() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 h-full overflow-auto">
      ...
      <p className="text-gray-600 mb-8">Last Updated: May 12, 2025</p>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">Introduction</h2>
        <p className="mb-4">
          {`Welcome to Waypoint Maker. These Terms of Service ("Terms") govern your access to and use of the Waypoint Maker website and services available at https://waypointmaker.app/ (collectively, the "Service").`}
        </p>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          We may impose limits on the number of missions you can create based on your account type. As indicated in our system configuration, there may be a maximum number of missions per user. Once you reach this limit, you will not be able to create additional missions until you delete existing ones or upgrade your account (if applicable).
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold mb-3">Mission Data</h3>
        <p className="mb-4">
          When you create missions through our Service, you retain ownership of your content. However, by creating and storing mission data on our platform, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, modify, adapt, publish, and display such content solely for the purpose of providing and improving the Service.
        </p>

        <h3 className="text-xl font-semibold mb-3">Public Missions</h3>
        <p className="mb-4">
          If you choose to make your missions public, you understand and agree that they may be accessible to other users of the Service. You are solely responsible for the missions you create and share.
        </p>

        <h3 className="text-xl font-semibold mb-3">Prohibited Content</h3>
        <p className="mb-4">You agree not to create or share missions that:</p>
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold mb-3">Mission Storage and Deletion</h3>
        <p className="mb-4">
          We reserve the right to delete inactive missions or accounts after an extended period of inactivity. We will attempt to notify you before such deletion occurs.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          The Service and its original content (excluding user-created missions), features, and functionality are and will remain the exclusive property of Waypoint Maker and its licensors. The Service is protected by copyright, trademark, and other laws.
        </p>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          In no event shall Waypoint Maker, its directors, employees, partners, agents, suppliers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:
        </p>
        <ul className="list-disc pl-6 mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          {`You agree to defend, indemnify, and hold harmless Waypoint Maker and its licensees, licensors, employees, contractors, agents, officers, and directors from and against any and all claims, damages, obligations, losses, liabilities, costs, or debt, and expenses (including but not limited to attorney's fees), resulting from or arising out of:`}
        </p>
        <ul className="list-disc pl-6 mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          These Terms constitute the entire agreement between you and Waypoint Maker regarding the Service and supersede all prior agreements and understandings, whether written or oral.
        </p>
      </section>
