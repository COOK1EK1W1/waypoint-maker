  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 h-full overflow-auto">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          {`
          Welcome to Waypoint Maker ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website https://waypointmaker.app/ (the "Site") and use our services.`}
        </p>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Use our mission creation and management features</li>
        ...
        <p className="mb-4">When you create, edit, or share missions, we collect and store:</p>
        <ul className="list-disc pl-6 mb-4">
          <li>Mission titles</li>
          <li>Mission content and configurations</li>
          <li>Public/private status of missions</li>
          <li>Other mission-related metadata</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>Fulfilling your requests for mission creation and management</li>
