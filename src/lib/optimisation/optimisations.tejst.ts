...
test.skip.each(squareStargingValues)("particle optimise square function", (...starting) => {
...
test.skip.each(squareStargingValues)("genetic optimise square function", (...starting) => {
...
test.skip.each(bowlStarting)("particle optimise bowl function", (...starting) => {
...
test.skip.each(bowlStarting)("genetic optimise bowl function", (...starting) => {
