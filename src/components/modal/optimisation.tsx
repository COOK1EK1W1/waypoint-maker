...
export default function OptimiseModal() {
	...
	return (
		...
		<div>
			...
			<Button onClick={() => runOptimisation(particleOptimise, worldPathLength)}>Opimise Length particle</Button>
			<Button onClick={() => runOptimisation(particleOptimise, pathEnergyRequirements)}>Optimise Energy particle</Button>
			{optimiseRes ? <div>
