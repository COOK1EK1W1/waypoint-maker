...
export default function MapControlls() {
  ...
  return (
    <div className="w-fit rounded-lg shadow-lg bg-card flex p-1">
      <span className="cursor-pointer hover:bg-muted rounded-lg p-1" onClick={() => mapRef.current?.zoomIn()}>
        <Plus className="h-5 w-5" />
      </span>
      <span className="cursor-pointer hover:bg-muted rounded-lg p-1" onClick={() => mapRef.current?.zoomOut()}>
